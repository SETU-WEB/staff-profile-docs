...
* [Entries](entries/README.md)
  ...
  * [Creating an Entry](entries/creating-an-entry/README.md)
    ...
    * [Inner Latest News](entries/creating-an-entry/inner-latest-news.md)
    * [Inner Latest Events](entries/creating-an-entry/inner-latest-events.md)
    * [Inner Testimonials](entries/creating-an-entry/inner-testimonials.md)
    * [Inner Recommended Courses](entries/creating-an-entry/inner-recommended-courses.md)
    * [Inner CTA Strip Section](entries/creating-an-entry/inner-cta-strip-section.md)
    * [Inner Staff Listing](entries/creating-an-entry/inner-staff-listing.md)
